...
# nohup python run_zsre_zh.py --editing_method=FT --hparams_dir=hparams/FT/llama-7b --data_dir=data > nohup_en_zh_ft
# nohup python run_zsre_zh.py --editing_method=ROME --hparams_dir=hparams/ROME/llama-7b --data_dir=data > nohup_en_zh_rome
# nohup python run_zsre_zh.py --editing_method=MEMIT --hparams_dir=hparams/MEMIT/llama-7b --data_dir=data > nohup_en_zh_memit

# python run_zsre_zh.py --editing_method=KN --hparams_dir=hparams/KN/llama-7b --data_dir=data
# python run_zsre_zh.py --editing_method=SERAC --hparams_dir=hparams/KN/llama-7b --data_dir=data
...
if __name__ == "__main__":
    ...
    # with open(os.path.join(args.data_dir, 'translated_zsre_portability_gpt4.json'), "r", encoding="utf-8") as f:
    #     test_data = f.readlines()

    # for idx,d in enumerate(test_data):
    #     test_data[idx] = eval(d.strip())

    with open("data/bi_zsre.json", "r", encoding="utf-8") as f:
